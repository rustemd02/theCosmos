...
<header class="site-header">
    ...
    <div class="buttons">
        <li style="float: left"><a class="active" href="/">Главная</a></li>
...
<div class="promo">
    ...
    <div class="cards">
        <img class="promoPhoto" src="../../resources/Assets/pushkin.jpeg" alt="">
        <div class="photosText"><p>Ходите в кино по Пушкинской карте! </p></div>
        <img class="promoPhoto" src="../../resources/Assets/wp1.jpg" alt="">
        <div class="photosText"><p>Подписчикам группы /vigvamcev предоставляется скидка 5% на все сеансы</p></div>
        <img class="promoPhoto" src="../../resources/Assets/cinema.jpeg" alt="">
        <div class="photosText"><p>Приходите!</p></div>
        <img class="promoPhoto" src="../../resources/Assets/bday.jpeg" alt="">
